...
class Class:
    ...
    def getAssignments(self, student_id) -> List['Assignment']:
        print(self.id, student_id)
        # https://www.oncourseconnect.com/json.axd/classroom/lms/assignments/get_assignment_listing?assignmentType=A&groupId=C8145234&studentId=11350268
        url = f"https://www.oncourseconnect.com/json.axd/classroom/lms/assignments/get_assignment_listing?assignmentType=A&groupId={self.id}&studentId={student_id}"
        response = self.requestSession.get(url)
